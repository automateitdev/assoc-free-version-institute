...
const refresher = async () => {
    const { data } = await postRequest('students/status-inactive', passedDataForRefresh.value);
...
<template>
    ...
    <h6 class="text-primary">Inactive<i class="pi pi-arrow-right"></i> Active</h6>
    <SearchForDataTables @coustomChange="(event) => {
        ...
        " getMethodUrl="without-merit-promotion/index" postMethodUrl="students/status-inactive">
    </SearchForDataTables>
                ...
                <div class="w-full ">
                    <div class="flex justify-content-end flex-wrap">
                        <Button :disabled="productLength"
                            ...
                            @click="setStaus"><span class="font-bold">Activate</span>
