...
const invoice = ref('QC498_A-101_231220131221');
const hr = ref('');
...
const printDocument = () => {
    ...
    const documentDefinition = {
        ...
        content: [
                ...
                columns: [
                    {
                        text: [
                            ...
                            `${student_details.value.academic_year}\n\n`,
                            { text: 'Student ID   :  ', bold: true },
                            `${student_details.value.custom_student_id}\n\n`,
                            { text: ' Name : ', bold: true },
                            `${student_details.value.student_name}\n\n`,
                    ...
                    },
                    {
                        text: [
                            ...
                            `${student_details.value.class_roll}\n\n`,
                            { text: 'Class-Shift-Section : ', bold: true },
                            `${student_details.value.class_name}-${student_details.value.shift}-${student_details.value.section}\n\n`.toUpperCase(),
                            { text: 'Payment Date : ', bold: true },
                            reportsDetails.value.paymentDate
                        ]
                    }
                ],
                margin: [0, 20, 0, 20]
            ...
            html,
            {
                columns: [{ text: `Collected By: ${hr.value}`, fontSize: 6, bold: true }]
            }
        ],
            ...
            <tfoot>
                <tr>
                    <td colspan="7" class="popi">
                        <span
                            >Powered By: Academy-Institute Management System
                        ...
                        >
                        <span align="end">Special Note: This Money Receipt was created on software and is valid without signatureand seal</span>
                    </td>
                </tr>
            </tfoot>
        </table>
    </div>
    <Button @click="printDocument">Download Payslip</Button>
</template>
